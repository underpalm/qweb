...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] text-[#1a1a1a] flex flex-col">
      ...
      {/* Footer */}
      <footer className="text-center border-t border-gray-200 py-3 bg-[#1a1a1a] text-white" data-testid="footer">
        ...
        <div className="flex justify-center space-x-4 mb-1 uppercase text-[9px] tracking-[0.15em] font-bold text-gray-400">
          ...
          <a href="https://www.linkedin.com/company/qradient" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">LinkedIn</a>
          <a href="#" className="hover:text-white transition-colors">Twitter</a>
        </div>
        <div className="flex justify-center space-x-4 mb-1 text-[10px] text-gray-500">
        ...
        <p className="text-[10px] text-gray-600">© 2026 QRADIENT. ALL RIGHTS RESERVED.</p>
      </footer>
