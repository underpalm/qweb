...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] text-[#1a1a1a] flex flex-col">
      ...
      {/* Footer */}
      <footer className="text-center border-t border-gray-100 py-6" data-testid="footer">
        <div className="text-3xl font-black tracking-tighter mb-4">QRADIENT.</div>
        <div className="flex justify-center space-x-8 mb-4 uppercase text-sm tracking-[0.2em] font-bold text-gray-400">
